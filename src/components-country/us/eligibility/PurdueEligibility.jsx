...
const PurdueEligibility = () => {
  ...
  const sections = [
    {
      ...
      content: [
        ...
        { 
          ...
          detail: 'Solid foundation in Mathematics, Physics, Chemistry, and preferably Computer Science for STEM; competitive majors like Engineering and CS have higher cut-offs and expectations.' 
        },
        { 
          label: 'Graduate / Master’s Programs',
          detail: 'Bachelor’s degree from a recognized university aligned with the chosen program, plus research experience, internships, or technical projects; some programs require prior coursework in math, circuits, or algorithms.' 
        }
      ]
    },
    {
      ...
      content: [
        { 
          ...
          detail: 'For international students: IELTS 6.5–7.0+, TOEFL iBT 90+ and Duolingo 110–120+ are typical competitive ranges, depending on department policies.' 
        },
        { 
          label: 'GRE / GMAT',
          detail: 'GRE is required or recommended for many MS and PhD programs, while GMAT is required for Krannert School of Management MBA, with some departments offering test-optional or waiver options.' 
        },
        { 
          label: 'Program Specific',
          detail: 'Score expectations and prerequisites vary by department, especially in Engineering, CS, data, and analytics-heavy programs.' 
        }
      ]
    }
  ];
  ...
  const stats = [
    { icon: <Users />,   label: 'Acceptance Rate',        value: '≈50–60%',  color: 'bg-yellow-600' },
    { icon: <TrendingUp />, label: 'Avg Starting Salary', value: '$70k+',   color: 'bg-green-500' },
    { icon: <Award />,   label: 'Top Strengths',          value: 'Engg • CS • Aero', color: 'bg-amber-500' },
    ...
    <div className="min-h-screen bg-gray-50 dark:bg-slate-950 transition-colors duration-500 pb-20 overflow-hidden">
      ...
      <div className="fixed inset-0 pointer-events-none overflow-hidden">
        <motion.div
          ...
          className="absolute top-20 right-20 w-96 h-96 bg-yellow-600/15 dark:bg-yellow-600/10 rounded-full blur-3xl"
        />
        <motion.div
      ...
      <motion.div style={{ opacity, scale }} className="relative h-[70vh] w-full overflow-hidden">
        ...
        >
          <img
            src="/assets/colleges/purdue.jpg"
          ...
          />
          <div className="absolute inset-0 bg-gradient-to-r from-yellow-900/60 via-transparent to-yellow-600/40 opacity-80" />
          {[...Array(15)].map((_, i) => (
            <motion.div
              key={i}
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center text-center px-6">
          ...
          >
            ...
            >
              ...
              High-ROI Engineering Powerhouse
            </motion.div>
            <h1 className="text-5xl md:text-7xl font-black text-white mb-4 tracking-tight">
              Purdue University
            </h1>
            <p className="text-xl md:text-2xl text-white/90 font-medium max-w-2xl">
              Strong Engineering and CS with Excellent Value for Money
            </p>
          </motion.div>
        </div>
        ...
        <div className="absolute top-32 left-6 lg:left-20 z-20">
          <motion.button
            ...
            whileTap={{ scale: 0.95 }}
            className="group flex items-center gap-2 bg-white/10 backdrop-blur-xl border border-white/30 text-white px-6 py-3 rounded-full font-bold hover:bg-white hover:text-yellow-700 transition-all shadow-2xl relative overflow-hidden"
          >
            ...
            <div className="lg:sticky lg:top-32 space-y-6">
              ...
              >
                ...
                <motion.div
                  ...
                  animate="animate"
                  className="w-16 h-16 bg-gradient-to-br from-yellow-700 to-yellow-500 rounded-2xl mb-6 flex items-center justify-center shadow-xl rotate-3 relative"
                >
                  <motion.div
                    animate={{ rotate: 360 }}
                    transition={{ duration: 20, repeat: Infinity, ease: 'linear' }}
              ...
              <motion.div
                variants={itemVariants}
                whileHover={{ scale: 1.02 }}
                className="relative bg-gradient-to-br from-yellow-700 via-yellow-600 to-yellow-800 p-8 rounded-[2.5rem] text-white shadow-2xl overflow-hidden group"
              >
                <motion.div
                ...
                <p className="text-sm font-medium leading-relaxed italic relative z-10">
                  "Purdue values strong quantitative skills and project-based learning. Show how your engineering, CS, or applied science work solves real-world problems."
                </p>
              </motion.div>
            </div>
          </div>
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              {sections.map((section, idx) => (
                ...
                >
                  <div className="absolute inset-0 bg-gradient-to-br from-yellow-500/0 via-blue-500/0 to-amber-500/0 group-hover:from-yellow-500/5 group-hover:via-blue-500/5 group-hover:to-amber-500/5 transition-all duration-500" />
            ...
            >
              ...
              <div className="grid md:grid-cols-2 gap-4 relative z-10">
                {[
                  'Online application via Purdue application portal',
                  'Statement of Purpose (SOP)',
                  '2–3 Letters of Recommendation (mainly for graduate)',
                  'Official academic transcripts',
                  'Resume / CV (mandatory for graduate applicants)',
                  ...
                  <motion.div
                    ...
                    viewport={{ once: true }}
                    className="flex items-center gap-3 bg-white/5 backdrop-blur-sm p-4 rounded-2xl border border-white/10 hover:border-yellow-500/50 hover:bg.white/10 transition-all cursor-pointer group"
                  >
                    <motion.div
                      whileHover={{ rotate: 360, scale: 1.2 }}
                      transition={{ duration: 0.5 }}
                    >
                      <CheckCircle2 className="text-yellow-400 group-hover:text-green-400 transition-colors" size={18} />
                    </motion.div>
            ...
            >
              <motion.div
                ...
                className="absolute -top-10 -right-10 w-40 h-40 bg-yellow-100 dark:bg-yellow-900/20 rounded-full blur-3xl"
              />
              ...
              <div className="grid md:grid-cols-2 gap-8 items-center relative z-10">
                <div className="space-y-4">
                  {[
                    'Engineering fundamentals, quantitative strength, and consistent grades',
                    'Project-based learning, labs, internships, and problem-solving skills',
                    'Initiative, collaboration, and impact through teams or clubs',
                    'Integrity, ethical conduct, and clear career goals in engineering, aerospace, manufacturing, or tech'
                  ].map((rule, i) => (
                    <motion.div
                      key={i}
                      initial={{ opacity: 0, x: -20 }}
                    ...
                    >
                      <motion.div
                        ...
                        className="w-2 h-2 rounded-full bg-yellow-700 group-hover:bg-green-500 transition-colors"
                      />
                      <span className="text-md font-bold text-gray-700 dark:text-slate-300 group-hover:text-yellow-700 dark:group-hover:text-yellow-400 transition-colors">
                        {rule}
                      </span>
                    </motion.div>
                  ))}
                ...
                >
                  ...
                  <h4 className="text-xl font-black mb-2 relative z-10 flex items-center gap-2">
                    <Award size={24} />
                    Affordable, Limited Aid
                  </h4>
                  <p className="text-sm font-medium leading-relaxed relative z-10">
                    International undergraduates pay a subtotal tuition around $31k per year, and with living costs total yearly expense typically reaches or exceeds the low-30k to mid-30k range, while Purdue is need-aware and offers limited direct aid to international students, relying more on merit scholarships, assistantships, and fellowships at advanced levels. [web:103][web:104][web:105][web:101]
                  </p>
                </motion.div>
              </div>
            </motion.div>
...
export default PurdueEligibility;
