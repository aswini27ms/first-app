...
const CornellEligibility = () => {
  ...
  const sections = [
    {
      ...
      content: [
        { 
          ...
          detail: "Completion of 12 years of formal schooling with strong performance, generally in the top 5–10% of your class." 
        },
        { 
          label: "Core Preparation", 
          detail: "Solid preparation in Mathematics, Sciences (Physics/Chemistry for STEM), and analytical writing; course rigor and consistency are critical." 
        },
        { 
          label: "Graduate / Master’s Programs", 
          detail: "Bachelor’s degree from a recognized university with strong alignment to the chosen program plus research projects, internships, or relevant industry experience; program-specific prerequisites apply, especially for Engineering and CS." 
        }
      ]
    },
    {
      ...
      content: [
        { 
          ...
          detail: "For international students: IELTS 7.0+; TOEFL iBT around 100+; Duolingo 120+ depending on program and college requirements." 
        },
        { 
          label: "GRE / GMAT", 
          detail: "GRE is required or recommended for many MS and PhD programs; GMAT is required for the Cornell Johnson School MBA, with waivers in some cases." 
        },
        { 
          label: "Program Specific", 
          detail: "Some departments are test-optional, but strong quantitative scores and academic records significantly strengthen applications." 
        }
      ]
    }
  ];
  ...
  const stats = [
    { icon: <Users />, label: "Acceptance Rate", value: "≈7–9%", color: "bg-red-700" },
    { icon: <TrendingUp />, label: "Avg Starting Salary", value: "$85k+", color: "bg-green-500" },
    { icon: <Award />, label: "Ivy League Status", value: "Big Red", color: "bg-amber-500" },
    ...
    <div className="min-h-screen bg-gray-50 dark:bg-slate-950 transition-colors duration-500 pb-20 overflow-hidden">
      ...
      <div className="fixed inset-0 pointer-events-none overflow-hidden">
        <motion.div 
          ...
          className="absolute top-20 right-20 w-96 h-96 bg-red-700/15 dark:bg-red-700/10 rounded-full blur-3xl"
        />
        <motion.div 
          animate={{ 
            x: [0, -150, 0],
      ...
      >
        ...
        >
          <img 
            src="/assets/colleges/cornell.jpg" 
          ...
          />
          <div className="absolute inset-0 bg-gradient-to-r from-red-900/60 via-transparent to-red-700/40 opacity-80" />
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center text-center px-6">
          ...
          >
            ...
            <p className="text-xl md:text-2xl text-white/90 font-medium max-w-2xl">
              Ivy League Depth with Real-World Application
            </p>
          </motion.div>
        </div>
            ...
            <div className="lg:sticky lg:top-32 space-y-6">
              ...
              >
                ...
                <h1 className="text-4xl font-black text-gray-900 dark:text-white mb-2 leading-tight">
                  Cornell <span className="text-red-800 italic block">University</span>
                </h1>
                ...
                <div className="space-y-4 pt-6 border-t border-gray-100 dark:border-slate-800">
                  {[
                    { label: "Early Decision", date: "November" },
                    { label: "Regular", date: "January" }
                  ].map((deadline, idx) => (
                    <motion.div 
                      key={idx}
                      whileHover={{ x: 5 }}
              ...
              >
                ...
                <p className="text-sm font-medium leading-relaxed italic relative z-10">
                  "Cornell blends Ivy League depth with hands-on problem solving. Show how you turn theory into practical impact."
                </p>
              </motion.div>
            </div>
          </div>
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            >
              ...
              <div className="grid md:grid-cols-2 gap-4 relative z-10">
                {[
                  "Online application via Common App / Cornell portal",
                  "Statement of Purpose / Personal Statement",
                  "2–3 Letters of Recommendation",
                  "Official academic transcripts",
                  "Resume / CV (for most graduate programs)",
                  "Portfolio, research papers, or project work (if applicable)"
                ].map((item, i) => (
                  <motion.div 
                    key={i}
            ...
            >
              ...
              <div className="grid md:grid-cols-2 gap-8 items-center relative z-10">
                <div className="space-y-4">
                  {[
                    "Academic rigor, depth, and consistency",
                    "Research capability and innovation",
                    "Leadership, initiative, and collaboration",
                    "Integrity, ethics, and clear academic/career goals"
                  ].map((rule, i) => (
                    <motion.div 
                      key={i} 
                      initial={{ opacity: 0, x: -20 }}
                    ...
                    >
                      <motion.div 
                        ...
                        className="w-2 h-2 rounded-full bg-red-700 group-hover:bg-green-500 transition-colors"
                      />
                      <span className="text-md font-bold text-gray-700 dark:text-slate-300 group-hover:text-red-700 dark:group-hover:text-red-400 transition-colors">{rule}</span>
                    </motion.div>
                  ))}
                </div>
                ...
                >
                  ...
                  <p className="text-sm font-medium leading-relaxed relative z-10">
                    Annual tuition is around $59k for many undergraduate programs, and Cornell is need-aware for international students; aid is primarily need-based, with college-level scholarships and fellowships available for strong profiles. [web:52][web:53][web:55][web:58]
                  </p>
                </motion.div>
              </div>
            </motion.div>
            ...
            >
              ...
              >
                ...
                Deadlines are strict — apply on time
              </motion.p>
            </motion.div>
...
export default CornellEligibility;
