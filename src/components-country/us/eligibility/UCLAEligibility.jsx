...
const UCLAEligibility = () => {
  ...
  const sections = [
    {
      ...
      content: [
        { 
          ...
          detail: "Completion of 12 years of formal schooling with excellent academic performance, typically within the top 9% of your class." 
        },
        { 
          label: "Core Preparation", 
          detail: "Strong preparation in Mathematics, Sciences (Physics/Chemistry for STEM), and analytical writing, with rigorous coursework strongly preferred." 
        },
        { 
          label: "Graduate / Master’s Programs", 
          detail: "Bachelor’s degree from a recognized university with strong alignment to the chosen program and a track record of research projects, internships, or industry experience; program-specific prerequisites apply, especially in Engineering and CS." 
        }
      ]
    },
    {
      ...
      content: [
        { 
          ...
          detail: "For international students: IELTS 7.0+ and TOEFL iBT roughly 90–100+ are competitive for many programs, with some accepting Duolingo scores around 120+ where allowed." 
        },
        { 
          label: "GRE / GMAT", 
          detail: "GRE is required or recommended for many MS and PhD programs; GMAT is required for the Anderson School of Management MBA, with some departments following test-optional or waiver policies." 
        },
        { 
          label: "Program Specific", 
          detail: "Individual departments may have higher score expectations and additional prerequisites in math, statistics, or core disciplinary subjects." 
        }
      ]
    }
  ];
  ...
  const stats = [
    { icon: <Users />, label: "Acceptance Rate", value: "≈9–11%", color: "bg-blue-600" },
    { icon: <TrendingUp />, label: "Avg Starting Salary", value: "$80k+", color: "bg-green-500" },
    { icon: <Award />, label: "Public Rank", value: "Top Public", color: "bg-amber-500" },
    ...
    <div className="min-h-screen bg-gray-50 dark:bg-slate-950 transition-colors duration-500 pb-20 overflow-hidden">
      ...
      <div className="fixed inset-0 pointer-events-none overflow-hidden">
        <motion.div 
          ...
          className="absolute top-20 right-20 w-96 h-96 bg-blue-600/15 dark:bg-blue-600/10 rounded-full blur-3xl"
        />
        <motion.div 
          animate={{ 
            x: [0, -150, 0],
      ...
      >
        ...
        >
          ...
          />
          <div className="absolute inset-0 bg-gradient-to-r from-blue-900/60 via-transparent to-blue-700/40 opacity-80" />
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center text-center px-6">
          ...
          >
            ...
            <p className="text-xl md:text-2xl text-white/90 font-medium max-w-2xl">
              Elite Public Academics with Global Industry Exposure
            </p>
          </motion.div>
        </div>
            ...
            <div className="lg:sticky lg:top-32 space-y-6">
              ...
              >
                ...
                <h1 className="text-4xl font-black text-gray-900 dark:text-white mb-2 leading-tight">
                  UCLA <span className="text-blue-700 italic block">University of California, Los Angeles</span>
                </h1>
                <p className="text-gray-500 dark:text-slate-400 font-medium mb-6 flex items-center gap-2">
                  <Star size={16} className="text-amber-400 fill-amber-400" />
                  Public Research University • Los Angeles, CA
                </p>
              ...
              >
                ...
                <p className="text-sm font-medium leading-relaxed italic relative z-10">
                  "UCLA blends top public academics with Los Angeles industry exposure. Show academic rigor, impact, and readiness for a fast-paced, diverse environment."
                </p>
              </motion.div>
            </div>
          </div>
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              {sections.map((section, idx) => (
                ...
                >
                  {/* Hover Glow Effect */}
                  <div className="absolute inset-0 bg-gradient.to-br from-blue-500/0 via-amber-500/0 to-purple-500/0 group-hover:from-blue-500/5 group-hover:via-amber-500/5 group-hover:to-purple-500/5 transition-all duration-500" />
            ...
            >
              ...
              <div className="grid md:grid-cols-2 gap-4 relative z-10">
                {[
                  ...
                  "2–3 Letters of Recommendation (mostly for graduate)",
              ...
              <div className="grid md:grid-cols-2 gap-8 items-center relative z-10">
                <div className="space-y-4">
                  {[
                    ...
                    "Leadership, initiative, and contribution to community",
                    "Ethical conduct, integrity, and clear academic/career goals"
                  ].map((rule, i) => (
                    <motion.div 
                      key={i} 
                      initial={{ opacity: 0, x: -20 }}
                    ...
                    >
                      <motion.div 
                        ...
                        className="w-2 h-2 rounded-full bg-blue-700 group-hover:bg-green-500 transition-colors"
                      />
                      <span className="text-md font-bold text-gray-700 dark:text-slate-300 group-hover:text-blue-700 dark:group-hover:text-blue-400 transition-colors">{rule}</span>
                    </motion.div>
                  ))}
                </div>
                ...
                >
                  ...
                  <p className="text-sm font-medium leading-relaxed relative z-10">
                    Base tuition and fees for nonresidents are in the low-40k USD range per year, but once nonresident supplemental tuition and living costs are included, total annual costs can exceed $70k–80k, and direct institutional aid for F-1 students is limited to select scholarships and external funding. [web:72][web:73][web:74][web:76][web:77][web:79]
                  </p>
                </motion.div>
              </div>
            </motion.div>
            ...
            >
              ...
              >
                ...
                UC application window is fixed — no late submissions
              </motion.p>
            </motion.div>
...
export default UCLAEligibility;
