...
const ColumbiaEligibility = () => {
  ...
  const sections = [
    {
      ...
      content: [
        { 
          ...
          detail: "Completion of 12 years of formal schooling with excellent performance, typically in the top 5–10% of your class." 
        },
        { 
          label: "Core Preparation", 
          detail: "Strong foundation in Mathematics, Sciences, and humanities with analytical writing; rigorous coursework and intellectual depth are valued." 
        },
        { 
          label: "Graduate / Master’s Programs", 
          detail: "Bachelor’s degree from a recognized university with strong alignment to the chosen discipline plus research work, internships, or industry experience." 
        }
      ]
    },
    {
      ...
      content: [
        { 
          ...
          detail: "For international students: IELTS 7.0+; TOEFL iBT around 100+; Duolingo 120+ for some programs, depending on school and level." 
        },
        { 
          label: "GRE / GMAT", 
          detail: "GRE is required or recommended for many MS and PhD programs; GMAT is required for Columbia Business School MBA, with test waivers in some cases." 
        },
        { 
          label: "Program Specific", 
          detail: "Some departments offer test-optional policies, but strong scores help demonstrate readiness for quantitative and analytical rigour." 
        }
      ]
    }
  ];
  ...
  const stats = [
    { icon: <Users />, label: "Acceptance Rate", value: "≈4–6%", color: "bg-red-500" },
    { icon: <TrendingUp />, label: "Avg Starting Salary", value: "$90k+", color: "bg-green-500" },
    { icon: <Award />, label: "Ivy League Rank", value: "Top Global", color: "bg-amber-500" },
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-slate-950 transition-colors duration-500 pb-20 overflow-hidden">
      ...
      >
        ...
        >
          <img 
            src="/assets/colleges/columbia.jpg" 
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center text-center px-6">
          ...
          >
            ...
            <p className="text-xl md:text-2xl text-white/90 font-medium max-w-2xl">
              Where Global Leadership Meets Urban Innovation
            </p>
          </motion.div>
        </div>
            ...
            <div className="lg:sticky lg:top-32 space-y-6">
              ...
              >
                ...
                <p className="text-sm font-medium leading-relaxed italic relative z-10">
                  "Columbia combines Ivy League depth with global city opportunity. Show intellectual curiosity, impact, and readiness for a fast-paced environment."
                </p>
              </motion.div>
            </div>
          </div>
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            >
              ...
              <div className="grid md:grid-cols-2 gap-4 relative z-10">
                {[
                  "Online application via Common App / Columbia portal",
                  "Personal Statement / Statement of Purpose",
                  "2–3 Letters of Recommendation",
                  "Official academic transcripts",
                  "Resume / CV (for graduate applicants)",
                  "Writing samples, portfolio, or research work (if applicable)"
                ].map((item, i) => (
                  <motion.div 
                    key={i}
              ...
              <div className="grid md:grid-cols-2 gap-8 items-center relative z-10">
                <div className="space-y-4">
                  {[
                    ...
                    "Research, innovation, and analytical thinking",
                    "Leadership, diversity, and global perspective",
                    "Ethical conduct and strong communication skills"
                  ].map((rule, i) => (
                    <motion.div 
                      key={i} 
                      initial={{ opacity: 0, x: -20 }}
                ...
                >
                  ...
                  <h4 className="text-xl font-black mb-2 relative z-10 flex items-center gap-2">
                    <Award size={24} />
                    Need-Aware, Full-Need Met
                  </h4>
                  <p className="text-sm font-medium leading-relaxed relative z-10">
                    Undergraduate tuition for internationals is around $60k–66k per year; Columbia is need-aware for international students but meets 100% of demonstrated need for those admitted with aid, with scholarships and fellowships varying by school and program. [web:55][web:56][web:58][web:61]
                  </p>
                </motion.div>
              </div>
            </motion.div>
            ...
            >
              ...
              >
                ...
                Plan early — Columbia deadlines are firm
              </motion.p>
            </motion.div>
...
export default ColumbiaEligibility;
